...
<div class="container-fluid p-4 bg-dark">
    ...
    <p class="fs-32px text-light text-center fw-bold col-8 mb-0">FORUMS -Admin</p>
    
{{-- create post btn --}}
<div class="col-1 mb-0 align-items-center">
    <a href="/admin/forum/create" class="text-decoration-none">
    ...
    <div>
        <div class="col-9">
            ...
            <div class="p-2 bg-{{ $index % 2 == 0 ? 'offWhite' : 'offWhite2' }}">
                ...
                <div class="row">
                {{-- display post title --}}
                <a href="{{ route('admin.forum.show', ['id' => $post]) }}" class="text-dark text-decoration-none">
